...
public enum PlanetaryBoundaryKind {
	...
	// <todo: review and refactor, use a consistent decomposition and aggregation approach, 80% complete >
	...
	BIOSHPERE_FUNCTIONAL_INTEGRITY ("Biospehre Functional Integrity"),
